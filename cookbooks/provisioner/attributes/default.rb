...
default['provisioner']['mirror_cname']                          = 'mirror.lab.fewt.com'
default['provisioner']['builder_cname']                         = "build#{node['platform_version'][0]}.lab.fewt.com"
default['provisioner']['provisioner_cname']                     = 'deploy.lab.fewt.com'

default['provisioner']['subnet']                                = '10.100.100.0'
default['provisioner']['netmask']                               = '255.255.255.0'
default['provisioner']['routers']                               = '10.100.100.1'
default['provisioner']['domain_name_servers']                   = '10.100.100.5, 10.100.100.6, 10.100.100.1'
...
default['provisioner']['cobbler']['hostname_url']                = "http://#{node['provisioner']['provisioner_cname']}/get/hostname"
...
default['provisioner']['cobbler']['bootimages']                  = { 'vmlinuz'    => "http://#{node['provisioner']['mirror_cname']}/mirrors/centos/7/os/x86_64/images/pxeboot/vmlinuz",
                                                                     'initrd.img' => "http://#{node['provisioner']['mirror_cname']}/mirrors/centos/7/os/x86_64/images/pxeboot/initrd.img" }
...
default['provisioner']['cobbler']['distros']                     = { 'CentOS-7-x86_64' => { 'name'       => 'CentOS-7-x86_64',
                                                                                            ...
                                                                                            'ksmeta'     => "tree=http://#{node['provisioner']['mirror_cname']}/mirrors/centos/7/os/x86_64",
                                                                                            'arch'       => 'x86_64',
                                                                                            'breed'      => 'redhat',
                                                                                            'os-version' => 'rhel7',
                                                                                            'repos'      => { 'base'    => "http://#{node['provisioner']['mirror_cname']}/mirrors/centos/7/os/x86_64",
                                                                                                              'updates' => "http://#{node['provisioner']['mirror_cname']}/mirrors/centos/7/updates/x86_64",
                                                                                                              'extras'  => "http://#{node['provisioner']['mirror_cname']}/mirrors/centos/7/extras/x86_64",
                                                                                                              'epel'    => "http://#{node['provisioner']['mirror_cname']}/mirrors/epel/7/x86_64/",
                                                                                                              'stable'  => "http://#{node['provisioner']['mirror_cname']}/mirrors/local/7/STABLE/RPMS"
                                                                                                            }
                                                                                         }
                                                                   }
...
default['provisioner']['cobbler']['repos']                       = { 'CentOS-7-x86_64' => { 'name'          => 'CentOS-7-x86_64',
                                                                                            ...
                                                                                            'breed'         => 'yum',
                                                                                            'keep-updated'  => 'False',
                                                                                            'mirror'        => "http://#{node['provisioner']['mirror_cname']}/mirrors/centos/7/os/x86_64/",
                                                                                            'owners'        => 'admin' }}
...
default['provisioner']['path']                                  = '/home/builder'
